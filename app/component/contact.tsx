    ...
    <div id="Contact">
      <section className="text-gray-400 body-font relative ">
        ...
        <div className="container px-5 py-24 mx-auto flex">
          <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md hover:bg-blue-100">
            ...
            <form action="https://formspree.io/f/xjkvaywl"
              method="POST">
              ...
              <button className="text-white bg-gray-900 body-font hover:bg-gray-500 border-0 py-2 px-6 focus:outline-none rounded text-lg">
                Send Message
              </button>
            </form>
          </div>
